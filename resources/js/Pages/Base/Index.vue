<template>
    ...
    <div class="container mt-4">
        <section class="header d-flex justify-content-between">
            ...
            <div>
                <button class="btn btn-primary-1 btn-sm mx-2 new-section" type="button" data-bs-toggle="modal" data-bs-target="#exampleModal2">
            ...
            <div class="row">
                ...
                <div class="col-md-2 col-6 my-2">
                  <div class="card" style="background: #1E293B; min-height: 200px;">
                    <a href="#">
                    <div class="card-body">
                      <svg style="float: right; color:rgb(255, 196, 0)" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-journals" viewBox="0 0 16 16">
